...
#define feedback_control_rtModel       RT_MODEL_feedback_control_T

/* External inputs (root inport signals with auto storage) */
typedef struct {
  real_T control_input;                /* '<Root>/Error[Deg]' */
} ExtU_feedback_control_T;

/* External outputs (root outports fed by signals with auto storage) */
typedef struct {
  real_T CoomandV;                     /* '<Root>/Coomand[V]' */
} ExtY_feedback_control_T;

/* Backward compatible GRT Identifiers */
#define rtU                            feedback_control_U
#define ExternalInputs                 ExtU_feedback_control_T
#define rtY                            feedback_control_Y
#define ExternalOutputs                ExtY_feedback_control_T
...
/* External inputs (root inport signals with auto storage) */
extern ExtU_feedback_control_T feedback_control_U;

/* External outputs (root outports fed by signals with auto storage) */
extern ExtY_feedback_control_T feedback_control_Y;

/*====================*
 * External functions *
 *====================*/
extern feedback_control_rtModel *feedback_control(void);
...
extern RT_MODEL_feedback_control_T *const feedback_control_M;
