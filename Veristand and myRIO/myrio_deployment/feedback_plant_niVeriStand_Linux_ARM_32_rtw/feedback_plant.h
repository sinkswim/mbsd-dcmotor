...
typedef struct {
  ...
  real_T damping;                      /* '<S3>/damping' */
  real_T Add;                          /* '<S3>/Add' */
  real_T Resistance;                   /* '<S3>/Resistance' */
  real_T Ke;                           /* '<S3>/Ke' */
  real_T Add1;                         /* '<S3>/Add1' */
  real_T Inductance;                   /* '<S3>/Inductance' */
  real_T Inertia;                      /* '<S3>/Inertia' */
} B_feedback_plant_T;
...
typedef struct {
   ...
   */
  real_T LookUpTable1_tableData[5];

  /* Expression: rep_seq_t - min(rep_seq_t)
   * Referenced by: '<S4>/Look-Up Table1'
   */
  real_T LookUpTable1_bp01Data[5];
...
typedef struct {
  real_T PositionDeg;                  /* '<Root>/Position[Deg]' */
...
#define rtU                            feedback_plant_U
#define ExternalInputs                 ExtU_feedback_plant_T
 ...
 * '<S2>'   : 'feedback_plant/Reference'
 * '<S3>'   : 'feedback_plant/DC Motor/DC Motor'
 * '<S4>'   : 'feedback_plant/Reference/Repeating Sequence'
 */
