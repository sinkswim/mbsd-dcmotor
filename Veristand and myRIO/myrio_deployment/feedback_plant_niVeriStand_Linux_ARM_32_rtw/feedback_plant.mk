# File    : feedback_plant.mk (for Release 2010b and later)
#
# Abstract:
...
MAKECMD         = C:\VeriStand\2016\ModelInterface\tmw\toolchain\Linux_ARM_32_GNU_Setup.bat && cs-make
HOST            = PC
BUILD           = yes
...
MODULES         		= feedback_plant_data.c ni_modelframework.c rtGetInf.c rtGetNaN.c rt_backsubrr_dbl.c rt_forwardsubrr_dbl.c rt_logging.c rt_lu_real.c rt_matrixlib_dbl.c rt_nonfinite.c 
MAKEFILE        		= feedback_plant.mk
...
MASTER_ANCHOR_DIR    	= 
START_DIR          		= C:/Users/VM-NI/Desktop/myrio_deployment
S_FUNCTIONS     		= 
S_FUNCTIONS_LIB 		= 
SOLVER          		= 
NUMST           		= 2
...
MODELLIB                  = feedback_plantlib.lib
MODELREF_LINK_LIBS   	  = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR)/feedback_plant_niVeriStand_Linux_ARM_32_rtw \
	-I$(START_DIR) \
